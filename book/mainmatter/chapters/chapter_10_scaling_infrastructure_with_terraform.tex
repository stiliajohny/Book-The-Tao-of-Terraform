...
In th\textbf{i}s example, the number of EC2 instances is controlled by the \texttt{instance\_count} variable. You can scale the infrastructure up or down simply by changing the value of this variable.
